...
// Add
	...
	find_replace_templatesets("forumbit_depth2_forum", "#".preg_quote(" id=\"mark_read_{\$forum['fid']}\"></span></td>")."#i", " id=\"mark_read_{\$forum['fid']}\"></span></td><td class=\"{\$bgcolor}\" align=\"center\" valign=\"top\" width=\"1\"><img src=\"Forum_Icons/{\$forum['icon']}\" alt=\"{\$forum['name']}\" /></td>");
	...
	find_replace_templatesets("forumbit_depth2_cat", "#".preg_quote("<td class=\"{\$bgcolor}\" valign=\"top\">")."#i", "<td class=\"{\$bgcolor}\" align=\"center\" valign=\"top\" width=\"1\"><img src=\"Forum_Icons/{\$forum['icon']}\" alt=\"{\$forum['name']}\" /></td><td class=\"{\$bgcolor}\" valign=\"top\">");
	$cache->update_forums();
}
